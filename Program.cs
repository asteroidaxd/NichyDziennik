namespace dziennik
{
    internal class Program
    {
        ...
        static void edycja()
        {
            ...
            while (poprawny == false)
            {
                if (wybor == "o+") { Console.Clear(); dodajOcene(); poprawny = true; }
                else if (wybor == "o-") { Console.Clear(); usunOcene(); poprawny = true; }
                else if (wybor == "p+") { Console.Clear(); dodajPrzedmiot(); poprawny = true; }
                else if (wybor == "p-") { Console.Clear(); usunPrzedmiot(); poprawny = true; }
                else
                {
                    Console.Clear();
                    Console.WriteLine("Co chesz zmodyfikowac: ");
